...
public class JavaGame
{
    ...
    public static final int moveLeftUpRightDownDiag = 5;
    public static final int moveRightDownLeftUpDiag = 6;
    public static final int moveLeftDownRightUpDiag = 7;
    public static final int moveRightUpLeftDownDiag = 8;
    ...
    public static void gameCycle()
    {
        ...
        {
            printMap();
            System.out.println("[Player info] > Health: " + playerHealth + ". Count steps: "
                    + playerCountStep + ". Player power: " + playerPowerPoint);
