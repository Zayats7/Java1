...
import java.awt.*;
    ...
    public class GameMap extends JPanel
    {
        ...
        void update(int direction)
        {
            ...
            {
                isGameStart = false;
                gameWindow.recordLog("Player is died!");
                JOptionPane.showMessageDialog(this, "Game over! Player is died! Count steps is "
                        + player.getStep() + ". Press OK and Start new game");
            }
        }
        ...
        public void playerNextMoveAction(int currentY, int currentX, int nextY, int nextX)
        {
            if (invisibleMap[nextY][nextX] == LABEL_ENEMY)
            {
                ...
                enemy.decreaseHealth(player.getPowerPoint());
                countEnemies--;
                gameWindow.recordLog("Alert! Enemy give damage " + enemy.getPowerPoint() + "Player give damage "
                        + getPlayerPowerInfo());
            }
        ...
        public int getHealthEnemiesInfo()
        {
        ...
        public int getPlayerPowerInfo()
        {
            return player.getPowerPoint();
        }
